      ...
      <Container className="relative">
        ...
        <div className="stats shadow bg-white w-full mb-16">
          <div className="stat place-items-center">
            ...
            <div className="stat-desc text-slate-500">From 100+ countries</div>
          </div>
          <div className="stat place-items-center">
          ...
          <div className="stat place-items-center">
            <div className="stat-title text-slate-600">Client Satisfaction</div>
          ...
          <div className="card bg-white shadow-lg max-w-2xl mx-auto">
            <div className="card-body items-center">
              ...
              <p className="text-slate-600 mb-6">
                Join thousands of professionals who've already streamlined their
                time tracking.
              </p>
              ...
              <p className="text-sm text-slate-500 mt-4">100% Free Forever!</p>
            </div>
          </div>
        </div>
      </Container>
